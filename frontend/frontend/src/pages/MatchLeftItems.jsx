...
export default function MatchLeftItems() {
  const { id } = useParams();
  ...
  const leftItems = [
    { id: 1, text: 'Sender', sortOrder: 'asc' },
    { id: 2, text: 'Message', sortOrder: 'asc' },
    { id: 3, text: 'Medium', sortOrder: 'asc' },
    { id: 4, text: 'Receiver', sortOrder: 'asc' },
  ];

  return (
    <div className="p-6 bg-[#f1f4f9] min-h-screen">
      <PageHeader title="Match Left Items" breadcrumbs={breadcrumbs} />
            ...
            <thead>
              <tr className="bg-[#701a5e] text-white">
                ...
                <th className="py-2.5 px-4 font-medium border-r border-purple-900/40">
                  Left Item Text <span className="text-xs opacity-70">↑↓</span>
                </th>
