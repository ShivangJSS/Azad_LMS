...
class ModuleTimeSpent(BaseModel):
    module_id: int
    module_name: str
    time_spent_seconds: int


class ParticipantTimeSpentResponse(BaseModel):
    participant_id: int
    total_time_spent_seconds: int
    modules: list[ModuleTimeSpent]
...
class ParticipantModulesResponse(BaseModel):
    participant_id: int
    language_id: int
    modules: List[ParticipantModuleResponse]


class ParticipantModuleActionResponse(BaseModel):
    success: bool
    message: str