...
from app.modules.mobile.assessment.ref_resolver import in_language, ref_ids
...
class QuestionRepository:
    ...
    @staticmethod
    def mcq_questions(db: Session, module_id: int, language_id: int):
        ids, borrowed = ref_ids(db, module_id, "MCQ")
    ...
    @staticmethod
    def scq_questions(db: Session, module_id: int, language_id: int):
        ids, borrowed = ref_ids(db, module_id, "SCQ")
    ...
    @staticmethod
    def drop_bucket_questions(db: Session, module_id: int, language_id: int):
        ids, borrowed = ref_ids(db, module_id, "DB")
    ...
    @staticmethod
    def match_questions(db: Session, module_id: int, language_id: int):
        ids, borrowed = ref_ids(db, module_id, "MM")
