...
#         # Step 2: Fetch user
#         user = AuthRepository.get_user_by_email_or_username(
#             db,
#             login_data.email,
#         )
...
#                 "state": (
#                     str(user.state_lgd_code)
#                     if (user.state_lgd_code is not None)
#                     else ""
...
#                     else ""
#                 ),
#                 "centre": (str(user.centre_id) if (user.centre_id is not None) else ""),
#             }
#         )
...
#         user = AuthRepository.get_user_by_login(
#             db,
#             login_data.email,
#         )
...
class AuthService:
        ...
        access_token = create_access_token(
            {
                ...
                "email": str(user.email),
                "role": str(user.role),
                "state": str(user.state_lgd_code or ""),
                "district": str(user.district_lgd_code or ""),
                "centre": str(user.centre_id or ""),
            }
        )
    ...
    def reset_password(
        ...
        payload = verify_reset_password_token(
            request.reset_token,
        )
