...
class BatchMaster(Base):
    ...
    centre_id = Column(
        BigInteger, ForeignKey("centre_masters.centre_id"), nullable=False
    )  # Corrected FK table name
...
class BatchParticipant(Base):
    ...
    batch_id = Column(
        BigInteger, ForeignKey("batch_masters.batch_id"), nullable=False
    )  # Added FK
    participant_id = Column(
        BigInteger, ForeignKey("participantmasters.participant_id"), nullable=False
    )  # Added FK
